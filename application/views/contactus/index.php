...
<div id="contact_wrapper">
     <div id="contact_inner">
          ...
          <div class="contact_addressbg">
               ...
               <a class="md-trigger viewmap map_color2" data-modal="modal-3"> <img src="images/plus.png" style="margin:-4px 5px 0 0;" > VIEW GOOGLE MAP </a>
               <div class="md-modal md-effect-1" id="modal-3">
                    <div class="md-content">
                         <a class="md-close close">X</a>
                         <div>
                              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3572.4098334272608!2d50.107844779113954!3d26.44251526085513!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDI2JzMyLjciTiA1MMKwMDYnMjkuMiJF!5e0!3m2!1sen!2sin!4v1439372530298" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                         </div>
                    </div>
               </div>
               <div class="md-overlay"></div><!-- the overlay element -->
     ...
     <div id="contactform_inner">
          ...
          <div id="formbg">
               ...
               <form method="post" name="form1" id="register-form" novalidate="novalidate"  action=""  enctype="multipart/form-data">
                    ...
                    <div class="field_label">
                         <div class="g-recaptcha" data-sitekey="6LeDkQsTAAAAABS6UZXDwgRqoV-dYqno8VPeEnYe"></div>
