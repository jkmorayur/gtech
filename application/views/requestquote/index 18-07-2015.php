...
//                    $.ajax({
//                         type : "POST",
//                         url : "<?php echo site_url('requestquote/processRequestquote'); ?>",
//                         data : formData,
//                         async: false,
//                         dataType : "json",
...
//             }
          ...
          $('.addmore').click(function () {
               ...
               $('#divRepairQuickQuote').append('<div class="field_label">' +
                       ...
                       '<textarea name="reqMessage[]" id="reqMessage'+rand+'" cols="" rows="" class="inputtextarea"></textarea>'+
                    ...
                    <div class="field_label">
                         ...
                         <span class="css4-metro-dropdown" style="width:100%;">
                              <select name="reqHearAboutUs">
                                   ...
                                   <option value="Transcat Catalog">Transcat Catalog</option>
                    ...
                    <div class="contact_panelbg">
                         ...
                         <div id="horizontalTab">
                              <ul class="resp-tabs-list">
                                   <li>Accredited Calibration Quick Quote</li>
                                   <li>Product Quick Quote </li>
                                   <li>Repair Quick Quote</li>
                              </ul>
                              ...
                              <div class="resp-tabs-container">
                                   <div>
                                        ...
                                        <div class="field_label" style="width:98%;min-height:60px; padding-left:0%;">
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;<input id="radPhone" type="radio" value="Data Included" name="reqCalibServiceOptns">
                                             Data Included &nbsp;&nbsp;&nbsp;&nbsp;
                                             <input id="radEmail" type="radio" value="Data & Uncertainties Included" name="reqCalibServiceOptns">
                                             Data & Uncertainties Included&nbsp;&nbsp;&nbsp;&nbsp;
                                             <input id="radEmail" type="radio" value="Without Data" name="reqCalibServiceOptns">
                                             Without Data
                                             <br /><span style="padding-left: 10px;" class="error" for="reqCalibServiceOptns" generated="true"></span>
                                        </div>
                                   ...
                                   <div>
                                        <div id="divRepairQuickQuote">
                                             ...
                                             <div class="field_label" style="width:99%;min-height:190px;">
                                                  ...
                                                  <textarea name="reqMessage[]" id='reqMessage' cols="" rows="" class="inputtextarea"></textarea>
                                             </div>
                                             <div style="clear:both;"></div>
                                        </div>
