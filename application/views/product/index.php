                         ...
                         <select id="cmbBrand">
                              ...
                              <?php if (!empty($brands)) { ?>
                                     ...
                                     foreach ($brands as $key => $value) {
                                          if (empty($brand_array) || in_array($value['brd_id'], $brand_array)) {
                                               ?>
...
<script type="text/javascript">
     $(document).ready(function () {
          ...
          $('#cmbBrand').change(function () {
               var url = '';
               var brandName = $('#cmbBrand').find('option:selected').text().toLowerCase().trim();
               ...
               if (brandName != 'filter_by_brands') {
                    ...
                    if (prod_in_brand == 1) {
                         if (url_segment[2] == 0 && url_segment[3] == 0) {
                              url = base_url + 'product/brand/' + brandName;
                         } else {
                              url = base_url + 'product/' + url_segment[2] + '/' + url_segment[3] + '/' + brandName;
                         }
                    } else {
                         url = base_url + 'brands/brand_details/' + brandName;
                    }
               } else {
                    url = base_url + 'product/' + url_segment[2] + '/' + url_segment[3] + '/';
               }
               window.location = url;
          });
     });
