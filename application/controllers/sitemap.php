<?php
  ...
  class Sitemap extends App_Controller {
       ...
       function product_site_map() {
            $this->page_title = "Product Site Map | General Tech Services LLC -". STATIC_TITLE;
            $this->render_page(strtolower(__CLASS__) . '/index');
       }
       
       function all_information_pages() {
            $this->page_title = "All Information Site Pages | General Tech Services LLC -". STATIC_TITLE;
