          ...
          <section class="col-lg-12 connectedSortable">
               ...
               <div class="box box-info">
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <select name="product[prd_type]" class="form-control" id="prd_type">
                                   ...
                                   <option <?php echo ($productsDetails['product_details']['prd_type'] == '1') ? "selected='selected'" : ''; ?>  value="1">1</option>
                                   <option <?php echo ($productsDetails['product_details']['prd_type'] == '2') ? "selected='selected'" : ''; ?>  value="2">2</option>
                                   <option <?php echo ($productsDetails['product_details']['prd_type'] == '3') ? "selected='selected'" : ''; ?>  value="3">3</option>
                              </select>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <input <?php echo ($productsDetails['product_details']['prd_ce'] == '1') ? 'checked="true"' : '';  ?>  value="1" type="checkbox" name="product[prd_ce]" id="prd_ce"/>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <input <?php echo ($productsDetails['product_details']['prd_provide_cali_service'] == '1') ? 'checked="true"' : '';  ?>  value="1" type="checkbox" name="product[prd_provide_cali_service]" id="provid_cali_service"/>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <input <?php echo ($productsDetails['product_details']['prd_genuine_product'] == '1') ? 'checked="true"' : '';  ?>  value="1" type="checkbox" name="product[prd_genuine_product]" id="prd_ce"/>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <input <?php echo ($productsDetails['product_details']['prd_replacement_guarantee'] == '1') ? 'checked="true"' : '';  ?>  value="1" type="checkbox" name="product[prd_replacement_guarantee]" id="prd_ce"/>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <input <?php echo ($productsDetails['product_details']['prd_free_shipping_in_UAE'] == '1') ? 'checked="true"' : '';  ?>  value="1" type="checkbox" name="product[prd_free_shipping_in_UAE]" id="prd_ce"/>
                              <span class="help-block"></span>
                         </div>
                    </div>
                    <!-- -->
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <div class="input-group" style="width: 100%;">
                                   <input value="<?php echo $productsDetails['product_details']['prd_page_title']; ?>" 
                                          placeholder="Page Title" type="text" name="product[prd_page_title]" id="prd_page_title" class='form-control'/>
                              </div>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <div class="input-group" style="width: 100%;">
                                   <input value="<?php echo $productsDetails['product_details']['prd_page_keyword']; ?>" 
                                          placeholder="Page Keyword" type="text" name="product[prd_page_keyword]" id="prd_page_keyword" class='form-control'/>
                              </div>
                         </div>
                    </div>
                    <div class="form-group">
                         ...
                         <div class="col-md-4">
                              <div class="input-group" style="width: 100%;">
                                   <input value="<?php echo $productsDetails['product_details']['prd_page_desc']; ?>"
                                          placeholder="Page Description" type="text" name="product[prd_page_desc]" id="prd_page_desc" class='form-control'/>
                              </div>
                         </div>
                    </div>
                    <!-- -->
                         ...
                         <div class="col-md-7" style="text-align: right;">
                              <div class="input-group" style="float: right;padding-right: 5px;">
                                   <div class="box-tools" style="display: table;">
                                        <label class="col-md-3 control-label" style="width: auto;">Add specifications</label>
